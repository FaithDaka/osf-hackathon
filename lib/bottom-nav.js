...
export default function BottomNav({ active, lang = 'en', strings }) {
  ...
  const tabs = [
    ...
    { path: '/announcements', label: 'Alerts', full: S.announcements || 'Announcements', Icon: BellIcon },
    { path: '/lc-initiatives', label: 'LC', full: S.lc_initiatives || 'LC Initiatives', Icon: LcIcon },
